...
class TC_GAME_API Transport : public GameObject, public TransportBase
{
    ...
    public:
        ...
        */
        TempSummon* SummonPassenger(uint32 entry, Position const& pos, TempSummonType summonType, SummonPropertiesEntry const* properties = nullptr, Milliseconds duration = 0s, Unit* summoner = nullptr, uint32 spellId = 0, uint32 vehId = 0);
