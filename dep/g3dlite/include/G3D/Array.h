...
public:
   ...
   void copyPOD(const Array<T>& other) {
       static_assert(std::is_trivially_copyable<T>::value, "copyPOD called on non-POD type");
   ...
   void appendPOD(const Array<T>& other) {
       static_assert(std::is_trivially_copyable<T>::value, "appendPOD called on non-POD type");
