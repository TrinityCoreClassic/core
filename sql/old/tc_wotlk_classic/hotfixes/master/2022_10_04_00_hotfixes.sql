...
CREATE TABLE `battle_pet_breed_state` (
  ...
  `BattlePetBreedID` int(11) NOT NULL DEFAULT '0',
  `VerifiedBuild` int(11) NOT NULL DEFAULT '0',
  PRIMARY KEY (`ID`,`VerifiedBuild`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `character_loadout` (
  ...
  `ModID` tinyint(4) NOT NULL DEFAULT '0',
  `VerifiedBuild` int(11) NOT NULL DEFAULT '0',
  PRIMARY KEY (`ID`,`VerifiedBuild`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `chr_races` (
  ...
  `Race_related` tinyint(4) NOT NULL DEFAULT '0',
...
CREATE TABLE `item` (
  ...
  `ModifiedCraftingReagentItemID` smallint(5) unsigned NOT NULL DEFAULT '0',
  `IconFileDataID` int(11) NOT NULL DEFAULT '0',
  ...
  `Field_3_4_0_45704_015` int(11) NOT NULL DEFAULT '0',
...
CREATE TABLE `item_bonus_tree_node` (
  ...
  `ParentItemBonusTreeID` int(11) NOT NULL DEFAULT '0',
  `VerifiedBuild` int(11) NOT NULL DEFAULT '0',
  PRIMARY KEY (`ID`,`VerifiedBuild`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `item_sparse` (
  ...
  `OppositeFactionItemID` int(11) NOT NULL DEFAULT '0',
  ...
  `StatModifier_bonusAmount1` smallint(6) NOT NULL DEFAULT '0',
  `StatModifier_bonusAmount2` smallint(6) NOT NULL DEFAULT '0',
  `StatModifier_bonusAmount3` smallint(6) NOT NULL DEFAULT '0',
  `StatModifier_bonusAmount4` smallint(6) NOT NULL DEFAULT '0',
  `StatModifier_bonusAmount5` smallint(6) NOT NULL DEFAULT '0',
  `StatModifier_bonusAmount6` smallint(6) NOT NULL DEFAULT '0',
  `StatModifier_bonusAmount7` smallint(6) NOT NULL DEFAULT '0',
  `StatModifier_bonusAmount8` smallint(6) NOT NULL DEFAULT '0',
  `StatModifier_bonusAmount9` smallint(6) NOT NULL DEFAULT '0',
  `StatModifier_bonusAmount10` smallint(6) NOT NULL DEFAULT '0',
...
CREATE TABLE `power_type` (
  ...
  `MaxBasePower` int(10) unsigned NOT NULL DEFAULT '0',
  `CenterPower` tinyint(4) NOT NULL DEFAULT '0',
  `DefaultPower` tinyint(4) NOT NULL DEFAULT '0',
  `DisplayModifier` smallint(5) unsigned NOT NULL DEFAULT '0',
...
CREATE TABLE `spell_item_enchantment` (
  ...
  `GemItemID` int(10) unsigned NOT NULL DEFAULT '0',
...
CREATE TABLE `spell_procs_per_minute_mod` (
  ...
  `SpellProcsPerMinuteID` int(11) NOT NULL DEFAULT '0',
  `VerifiedBuild` int(11) NOT NULL DEFAULT '0',
  PRIMARY KEY (`ID`,`VerifiedBuild`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `spell_visual_missile` (
  ...
  `SpellVisualMissileSetID` smallint(6) NOT NULL DEFAULT '0',
  `VerifiedBuild` int(11) NOT NULL DEFAULT '0',
  PRIMARY KEY (`ID`,`VerifiedBuild`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
