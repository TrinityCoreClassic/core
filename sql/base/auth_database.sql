...
-- Dumping database structure for tcc_auth
CREATE DATABASE IF NOT EXISTS `tcc_auth` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `tcc_auth`;

-- Dumping structure for table tcc_auth.account
...
-- Dumping data for table tcc_auth.account: ~0 rows (approximately)

-- Dumping structure for table tcc_auth.account_access
...
-- Dumping data for table tcc_auth.account_access: ~0 rows (approximately)

-- Dumping structure for table tcc_auth.account_banned
...
-- Dumping data for table tcc_auth.account_banned: ~0 rows (approximately)

-- Dumping structure for table tcc_auth.account_last_played_character
...
-- Dumping data for table tcc_auth.account_last_played_character: ~0 rows (approximately)

-- Dumping structure for table tcc_auth.account_muted
...
-- Dumping data for table tcc_auth.account_muted: ~0 rows (approximately)

-- Dumping structure for table tcc_auth.autobroadcast
...
-- Dumping data for table tcc_auth.autobroadcast: ~0 rows (approximately)

-- Dumping structure for table tcc_auth.battlenet_accounts
...
-- Dumping data for table tcc_auth.battlenet_accounts: ~0 rows (approximately)

-- Dumping structure for table tcc_auth.battlenet_account_bans
...
-- Dumping data for table tcc_auth.battlenet_account_bans: ~0 rows (approximately)

-- Dumping structure for table tcc_auth.battlenet_account_heirlooms
...
-- Dumping data for table tcc_auth.battlenet_account_heirlooms: ~0 rows (approximately)

-- Dumping structure for table tcc_auth.battlenet_account_mounts
...
-- Dumping data for table tcc_auth.battlenet_account_mounts: ~0 rows (approximately)

-- Dumping structure for table tcc_auth.battlenet_account_toys
...
-- Dumping data for table tcc_auth.battlenet_account_toys: ~0 rows (approximately)

-- Dumping structure for table tcc_auth.battlenet_account_transmog_illusions
...
-- Dumping data for table tcc_auth.battlenet_account_transmog_illusions: ~0 rows (approximately)

-- Dumping structure for table tcc_auth.battlenet_item_appearances
...
-- Dumping data for table tcc_auth.battlenet_item_appearances: ~0 rows (approximately)

-- Dumping structure for table tcc_auth.battlenet_item_favorite_appearances
...
-- Dumping data for table tcc_auth.battlenet_item_favorite_appearances: ~0 rows (approximately)

-- Dumping structure for table tcc_auth.battle_pets
...
-- Dumping data for table tcc_auth.battle_pets: ~0 rows (approximately)

-- Dumping structure for table tcc_auth.battle_pet_declinedname
...
-- Dumping data for table tcc_auth.battle_pet_declinedname: ~0 rows (approximately)

-- Dumping structure for table tcc_auth.battle_pet_slots
...
-- Dumping data for table tcc_auth.battle_pet_slots: ~0 rows (approximately)

-- Dumping structure for table tcc_auth.build_info
...
-- Dumping data for table tcc_auth.build_info: ~157 rows (approximately)
INSERT INTO `build_info` (`build`, `majorVersion`, `minorVersion`, `bugfixVersion`, `hotfixVersion`, `winAuthSeed`, `win64AuthSeed`, `mac64AuthSeed`, `winChecksumSeed`, `macChecksumSeed`) VALUES
	...
	(40618, 1, 14, 0, NULL, '1278EB34F243ED7898D614C0E278EAC0', '1278EB34F243ED7898D614C0E278EAC0', '7528AB80D693E149907757BC9540A6A6', NULL, NULL),
...
-- Dumping structure for table tcc_auth.ip_banned
...
-- Dumping data for table tcc_auth.ip_banned: ~0 rows (approximately)

-- Dumping structure for table tcc_auth.logs
...
-- Dumping data for table tcc_auth.logs: ~0 rows (approximately)

-- Dumping structure for table tcc_auth.logs_ip_actions
...
-- Dumping data for table tcc_auth.logs_ip_actions: ~0 rows (approximately)

-- Dumping structure for table tcc_auth.rbac_account_permissions
...
-- Dumping data for table tcc_auth.rbac_account_permissions: ~0 rows (approximately)

-- Dumping structure for table tcc_auth.rbac_default_permissions
...
-- Dumping data for table tcc_auth.rbac_default_permissions: ~4 rows (approximately)
...
-- Dumping structure for table tcc_auth.rbac_linked_permissions
...
-- Dumping data for table tcc_auth.rbac_linked_permissions: ~676 rows (approximately)
...
-- Dumping structure for table tcc_auth.rbac_permissions
...
-- Dumping data for table tcc_auth.rbac_permissions: ~695 rows (approximately)
...
-- Dumping structure for table tcc_auth.realmcharacters
...
-- Dumping data for table tcc_auth.realmcharacters: ~0 rows (approximately)

-- Dumping structure for table tcc_auth.realmlist
...
-- Dumping data for table tcc_auth.realmlist: ~1 rows (approximately)
INSERT INTO `realmlist` (`id`, `name`, `address`, `localAddress`, `address3`, `address4`, `localSubnetMask`, `port`, `icon`, `flag`, `timezone`, `allowedSecurityLevel`, `population`, `gamebuild`, `Region`, `Battlegroup`) VALUES
	(1, 'TrinityCoreClassic', '127.0.0.1', '127.0.0.1', NULL, NULL, '255.255.255.0', 8085, 0, 0, 1, 0, 0, 40618, 1, 1);

-- Dumping structure for table tcc_auth.secret_digest
...
-- Dumping data for table tcc_auth.secret_digest: ~0 rows (approximately)

-- Dumping structure for table tcc_auth.updates
...
-- Dumping data for table tcc_auth.updates: ~0 rows (approximately)

-- Dumping structure for table tcc_auth.updates_include
...
-- Dumping data for table tcc_auth.updates_include: ~0 rows (approximately)

-- Dumping structure for table tcc_auth.uptime
...
-- Dumping data for table tcc_auth.uptime: ~3 rows (approximately)
INSERT INTO `uptime` (`realmid`, `starttime`, `uptime`, `maxplayers`, `revision`) VALUES
	(1, 1754433945, 0, 0, 'TrinityCore rev. 258e2c25ccc6+ 2025-08-05 19:07:43 +0200 (vanilla_classic branch) (Windows, AMD64, Debug, Static)'),
	(1, 1754434067, 0, 0, 'TrinityCore rev. 258e2c25ccc6+ 2025-08-05 19:07:43 +0200 (vanilla_classic branch) (Windows, AMD64, Debug, Static)'),
	(1, 1754434276, 0, 0, 'TrinityCore rev. 258e2c25ccc6+ 2025-08-05 19:07:43 +0200 (vanilla_classic branch) (Windows, AMD64, Debug, Static)');

-- Dumping structure for view tcc_auth.vw_log_history
...
-- Dumping structure for view tcc_auth.vw_rbac
-- Creating temporary table to overcome VIEW dependency errors
CREATE TABLE `vw_rbac` (
	...
	`Security Level` VARCHAR(1) NOT NULL COLLATE 'utf8mb4_0900_ai_ci',
